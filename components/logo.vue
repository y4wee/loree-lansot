<template>
  <div class="logo">
    <svg :class="'logoSvg ' + className" viewBox="0 0 446 302" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
    ...
    mounted() {
        if(this.animation === true) {
            this.calculateDash(this.className);
        }
    },
    methods: {
        // calcule la longueur d'un path de svg
        calculateDash: function(data) {
